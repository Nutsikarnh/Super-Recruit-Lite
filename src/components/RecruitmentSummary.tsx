    ...
    <div className="overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-2.5 border-b border-gray-100">
        ...
        <button
          ...
          className="flex items-center gap-1 text-[12px] font-semibold text-[#127EE3] hover:text-[#0DC2FF] transition-colors"
        >
      ...
      <div className="px-6 pt-4 pb-4 grid grid-cols-[0.9fr_2.1fr] gap-0">
        ...
        <div className="flex flex-col gap-4 pr-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <span className="text-[11.5px] font-semibold text-gray-600">75K–95K THB</span>
            <div className="flex flex-wrap gap-1 mt-0.5">
              {["Figma", "Design System", "User Research"].map((s) => (
                <span key={s} className="text-[10px] font-semibold px-1.5 py-0.5 rounded bg-[#F0F8FF] border border-[#0DC2FF]/20 text-[#0277a8]">{s}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 pl-4 border-l border-[#E5E7EB]">
          ...
          <ul className="space-y-1.5">
            {[
              ...
              <li key={i} className="flex gap-2 text-[12px] text-gray-700 leading-relaxed list-none">
          ...
          <button
            onClick={onViewTopPicks}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-[#0DC2FF] to-[#127EE3] text-white text-[12.5px] font-bold shadow-md shadow-[#0DC2FF]/20 hover:shadow-[#0DC2FF]/35 hover:scale-[1.02] transition-all w-fit"
          >
      ...
      <div className="px-6">
        <table className="w-full">
          ...
          <tbody>
              ...
              >
                <td className="py-4">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="text-[15px] font-semibold text-[#1A1A2E] hover:text-[#127EE3] transition-colors text-left"
                    >
                      {job.title}
                    </button>
                ...
                {isJobFairTab && (
                  <td className="py-4 text-right">
                    {job.jobFairName ? (
                      <span className="text-[13px] text-gray-500 max-w-[180px] inline-block text-right leading-snug">
                        {job.jobFairName}
                      </span>
                    ) : null}
                  </td>
            ...
            {rows.length === 0 && (
              <tr>
                <td colSpan={5} className="py-10 text-center text-[14px] text-gray-400">
                  ไม่มีข้อมูล
                </td>
              </tr>
            )}
